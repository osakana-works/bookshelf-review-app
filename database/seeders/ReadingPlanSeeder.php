...
class ReadingPlanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $plans = [
            // 山田太郎：主要シナリオ
            ['user' => $yamada, 'book' => $bookByIsbn('9784101010014'), 'status' => ReadingPlanStatus::NotStarted, 'target_date' => Carbon::today()->addDays(10), 'completed_at' => null],
            ...
            ['user' => $yamada, 'book' => $bookByIsbn('9784863940246'), 'status' => ReadingPlanStatus::NotStarted, 'target_date' => Carbon::today()->addDays(3), 'completed_at' => null],
            ['user' => $yamada, 'book' => $bookByIsbn('9784101010021'), 'status' => ReadingPlanStatus::InProgress, 'target_date' => Carbon::today(), 'completed_at' => null],
            ['user' => $yamada, 'book' => $bookByIsbn('9784309226712'), 'status' => ReadingPlanStatus::NotStarted, 'target_date' => Carbon::today(), 'completed_at' => null],
            ...
            ['user' => $tanaka, 'book' => $bookByIsbn('9784101010014'), 'status' => ReadingPlanStatus::NotStarted, 'target_date' => Carbon::today()->addDays(14), 'completed_at' => null],
        ];
